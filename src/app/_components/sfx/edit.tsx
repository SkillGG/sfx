...
export const SFXEdit = ({
	...
	labels?: {
		...
		btns?: {
			edittl?: string
			cancel?: string
			save?: { save?: string; saving?: string; saved?: string }
		}
	}
								...
								<TLEditorDirect
									...
									classNames={{
										...
										tls: {
											...
											tl: {
												sfxedit: { main: 'bg-(--dialog-bg)/10' },
												default: { container: 'bg-(--dialog-bg)/10' },
											},
										},
									}}
								/>
