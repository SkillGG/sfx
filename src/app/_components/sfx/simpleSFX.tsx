...
const FieldTypeStyles: (
  scale: number,
) => Record<keyof SFXFieldsData | `${keyof SFXFieldsData}_j`, CSSProperties> = (
  scale,
) => ({
  read: {
    fontSize: `${18 / scale}px`,
    color: "#60a5fa",
  }, //"text-sm ml-2 text-(--sfx-read-text)",
  read_j: {
    marginLeft: "2.3em",
    fontSize: `${18 / scale}px`,
    color: "#60a5fa",
  ...
  extra: {
    ...
    color: "#3b82f6",
  }, //"text-sm whitespace-pre-wrap text-(--sfx-extra-text)",
  extra_j: {
    marginLeft: "2.3em",
    fontSize: `${14 / scale}px`,
    color: "#3b82f6",
    ...
    case "string":
      return (
        <div
          key={field.index}
          style={{
            ...FieldTypeStyles(textScale)[cType],
            display: "flex",
          }}
        >
