...
export type SFXCardClasses = {
	...
	bottominfo?: { container?: ClassValue; def?: ClassValue; extra?: ClassValue }
	tls?: { container?: ClassValue; sfx?: SFXClasses }
	tlExtras?: { container?: ClassValue; field?: ClassValue }
}
...
type ExtraFieldData = Record<
	string,
	{ raw: string; hide: { type: SFXField['type']; index: number[] }[] }
>
