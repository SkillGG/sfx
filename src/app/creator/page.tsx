...
import { TLCreator } from "../_components/TLEditor";
...
const CreatorPage = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex min-w-[20rem] flex-1 flex-col gap-4",
          "border-l border-blue-200 bg-blue-100 px-2",
          "dark:border-blue-700 dark:bg-slate-800",
        )}
      >
        <h2
          className={cn(
